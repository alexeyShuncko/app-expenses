...
const RenameCategory = (props) => {
  ...
  const onFinish = (values) => {
    ...
    if (props.diagramm.activ.name === values.select) {
      props.addActiv(
        props.diagramm.category.find((a) => a.name === values.select)
      );
    }
  };
      ...
      <div className={s.item}>
        <Form
          ...
          <Form.Item
            ...
            hasFeedback
            rules={[
              { required: true, message: 'Впишите новое название категории!' },
              { validator: validator },
            ]}>
        ...
        <div className={s.instruction}>
          <div>
            <div>
              1) Выберите категорию из выпадающего списка "Название категории"
            </div>
            <div>
              2) В поле "Новое название категории" впишите новое название
              категории<br></br>
              (Название не должно совпадать с уже имеющимися категориями,
              <br></br>
