...
const Relativity = (props) => {
  ...
  let selectArr = ['штука', 'пачка', 'литр', 'килограмм', 'пара', 'бутылка'];

  const funcValidText = (e) => {
    // валидация ввода, только русские буквы ... подумать над пробелом !!!!
      ...
      <div className={s.relativity}>
        <Form
          ...
          <Form.Item
            ...
            name="price"
            rules={[
              { required: true, message: 'Введите стоимость величины!' },
            ]}>
            <Input type={'number'} onInput={funcValidNumber} step="0.01" />
          </Form.Item>

          <Form.Item style={{ marginTop: 30 }} wrapperCol={{ offset: 10 }}>
            <Space>
        ...
        <div className={s.instruction}>
          <div>
            <div>
              1) В поле "Название величины" впишите название вашей величины
            </div>
            <div>
              2) Из выпадающего списка "Единицы измерения" выберите в чем
              измеряется ваша величина
            </div>
            <div>
              3) В поле "Стоимость" впишите стоимость за одну единицу вашей
              величины в бел. рублях
            </div>
            <div>
              4) Нажмите кнопку "Добавить"
              <div>
                (увидеть пересчёт ваших расходов в относительную величину вы
                можете на странице "Статистика", выбрав категорию)
              </div>
            </div>
          </div>
        </div>
